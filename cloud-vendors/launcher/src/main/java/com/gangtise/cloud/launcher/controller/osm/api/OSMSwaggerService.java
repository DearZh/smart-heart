...
public interface OSMSwaggerService {
    ...
    @ApiOperation(value = "新建华为工单", notes = "")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "type", value = "", required = true, dataType = "String", paramType = ""),
            @ApiImplicitParam(name = "productCategoryId", value = "工单产品类型", required = true, dataType = "String", paramType = ""),
            @ApiImplicitParam(name = "withSourceId", value = "工单来源ID", required = true, dataType = "String", paramType = ""),
            @ApiImplicitParam(name = "withBusinessTypeId", value = "工单问题类型ID", required = true, dataType = "String", paramType = ""),
    ...
    R insertOsm(CloudName type, String productCategoryId, String withSourceId, String withSimpleDescription, String withBusinessTypeId) throws Exception;
}
