...
public class AuthBuild {
     ...
     * @return
     */
    public AuthBuild buildIdentity(String userAccount, String iamUserAccount, String iamPassword) {
    ...
    public AuthBuild buildScope() {
        AuthObj.Scope scope = authObj.new Scope();

        return this;
    }

    public static AuthBuild create() {
        return new AuthBuild();
    }
        ...
        class Identity {
            ...
            class PassWord {
                ...
                class User {
                    ...
                    private Domain domain;  //IAM 用户所属的账号名
